 ...
 */
public class Missing_vehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.missing_vehicle);
    ...
    private void initViews() {
        ...
        btnAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplication(),Missing_info.class);
                startActivity(i);
                Toast.makeText(Missing_vehicle.this, "done", Toast.LENGTH_SHORT).show();
//
//
    ...
    private void initialiseDetectorsAndSources() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(Missing_vehicle.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(Missing_vehicle.this, new String[]{Manifest.permission.CAMERA}, REQUEST_CAMERA_PERMISSION);
                    }
                    ...
                    txtBarcodeValue.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (barcodes.valueAt(0).email != null) {
                                ...
                                sharedPrefHandler.setSharedPreferences("key",txt_val);
